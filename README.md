...
1000만 건 / Merchant 10,000개 조건에서는 `BASIC_LOOP`를 강제 실행하지 않고 DB GROUP BY 기반 전략인 GROUP_BY_QUERY와 GROUP_BY_BULK_SAVE를 측정했습니다.
...
| 데이터 건수 | Merchant 수 | 전략 | 실행 시간 | 결과 동일성 |
|---:|---:|---|---:|---|
| 10,000,000 | 10,000 | GROUP_BY_QUERY | 5,026ms | 기준 |
| 10,000,000 | 10,000 | GROUP_BY_BULK_SAVE | 4,596ms | GROUP_BY_QUERY와 동일 |
